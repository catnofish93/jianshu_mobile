...
let IconiconTest43 = ({ size, color, ...rest }) => {
  return (
...
IconiconTest43.defaultProps = {
  size: 18,
};

IconiconTest43 = React.memo ? React.memo(IconiconTest43) : IconiconTest43;

export default IconiconTest43;
