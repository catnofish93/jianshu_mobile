...
let IconiconTest35 = ({ size, color, ...rest }) => {
  return (
...
IconiconTest35.defaultProps = {
  size: 18,
};

IconiconTest35 = React.memo ? React.memo(IconiconTest35) : IconiconTest35;

export default IconiconTest35;
