...
let IconiconTest36 = ({ size, color, ...rest }) => {
  return (
...
IconiconTest36.defaultProps = {
  size: 18,
};

IconiconTest36 = React.memo ? React.memo(IconiconTest36) : IconiconTest36;

export default IconiconTest36;
